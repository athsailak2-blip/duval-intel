...
30 11 * * 1 /path/to/duval-intel/scripts/run_refresh.sh >> /path/to/duval-intel/logs/cron_p1.log 2>&1

# Monthly P2 refresh (1st of month at 7:00 AM EST)
0 12 1 * * /path/to/duval-intel/scripts/run_refresh.sh >> /path/to/duval-intel/logs/cron_p2.log 2>&1
'''
